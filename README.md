...
**[rails-react-app]** is amied at setting up two separate applications communicating via endpoints. 

## 🛠 Built With <a name=" Ruby on Rails 7.x, Postgresql"></a>
...
`git clone https://github.com/Abdullah2213565/rails-react-app2.git`
